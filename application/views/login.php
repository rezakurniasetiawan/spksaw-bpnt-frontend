...
<html lang="en">
    ...
    <body class="bg-gradient-success">
        <nav class="navbar navbar-expand-lg navbar-dark bg-white shadow-lg pb-3 pt-3 font-weight-bold">
            <div class="container">
                <a class="navbar-brand text-success" style="font-weight: 900;" href="<?= base_url('')?>"> <i class="fa fa-database mr-2 rotate-n-15"></i> Sistem Pendukung Keputusan Metode SAW</a>
            </div>
        </nav>
                                ...
                                <div class="col-lg-12">
                                    <div class="p-5">
                                        <div class="text-center">
                                            ...
                                            <p class="h4 text-gray-900 mb-4"><a class="navbar-brand text-success" style="font-weight: 900;" href="https://www.youtube.com/@kaseps8304/videos" ></a></p>
                                          <img src="assets/img/.png" alt="" width="60%" style="margin-bottom: 15px;">
                                        </div>
